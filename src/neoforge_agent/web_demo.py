...
<body>
  <header>
    <div>
      ...
      <div class="eyebrow">ModSpec-first / Direct Code Lane / Evidence</div>
      <h1>NeoForge Mod Agent 控制台</h1>
      <p class="lead">本地打开、现场操作：生成或修改 workspace，查看 audit/build、Direct Code Lane review / snapshot / rollback evidence、RAG / repair、资源预览和 harvest 线索。它不是通用 Coding Agent；Direct Code 只接受结构化 workspace patch。</p>
    </div>
    <div class="panel">
      <h2>运行状态</h2>
    ...
    <section class="results">
      <div class="panel">
        <div class="status">
          ...
          <div class="metric"><strong id="auditMetric">-</strong><span>audit/build/direct</span></div>
        </div>
      </div>
      <div class="panel">

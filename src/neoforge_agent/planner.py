...
from .workspace_materializer import WorkspaceMaterializer, feature_counts
...
class ModProjectPlanner:
    ...
    @property
    def builder(self):
        return self.materializer.builder

    @builder.setter
    def builder(self, value) -> None:
        self.materializer.builder = value
    ...
    def build_plan(self, run_build: bool) -> list[PlanStep]:
        return self.materializer.build_plan(run_build=run_build)

    def validate(self, spec: ModSpec) -> ValidationReport:
        return self.materializer.validate(spec)
    ...
    def execute_spec(
        ...
        *,
        ...
        return self.materializer.create_workspace(
            spec,
            workspace_name=workspace_name,
            overwrite=overwrite,
            run_build=run_build,
            parsed_from_request=parsed_from_request,
        )
    ...
    def _derive_pending_actions(self, spec: ModSpec) -> list[str]:
        return self.materializer.derive_pending_actions(spec)

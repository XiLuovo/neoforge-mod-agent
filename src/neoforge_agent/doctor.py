...
class EnvironmentDoctor:
    ...
    def _check_optional_docs(self) -> list[DoctorCheck]:
        docs = [
            ("docs.modspec", self.config.project_root / "docs" / "规格与生成" / "modspec.md", "ModSpec docs exist."),
            ("docs.testing", self.config.project_root / "docs" / "验证与可靠性" / "testing.md", "Testing docs exist."),
            ("docs.quality_gate", self.config.project_root / "docs" / "验证与可靠性" / "quality-gate.md", "Quality gate docs exist."),
            ("docs.ci", self.config.project_root / "docs" / "验证与可靠性" / "ci.md", "CI docs exist."),

...
这句话描述的是 V7.2 Quest / Advancement / Guide DSL 这个功能层的稳定路径边界，不否定 V8.4+ 的 `ModSpec-first hybrid` 架构。当前全局边界以 [project-limitations.md](project-limitations.md)、[direct-code-lane.md](direct-code-lane.md) 和 [agent-workflow.md](agent-workflow.md) 为准。

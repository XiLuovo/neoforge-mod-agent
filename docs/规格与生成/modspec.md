...
完整示例见 [`examples/world_ruby_realm.json`](../../examples/world_ruby_realm.json) 和 [`docs/规格与生成/world-structure-dsl.md`](world-structure-dsl.md)。
...
Full example: [`examples/controlled_java_extension.json`](../../examples/controlled_java_extension.json). More detail: [`docs/规格与生成/controlled-java-extension.md`](controlled-java-extension.md).
...
Full example: [`examples/progression_gameplay_loop.json`](../../examples/progression_gameplay_loop.json). More detail: [`docs/规格与生成/progression-dsl.md`](progression-dsl.md).
...
Full example: [`examples/balance_gameplay_loop.json`](../../examples/balance_gameplay_loop.json). More detail: [`docs/规格与生成/balance-planner.md`](balance-planner.md).
...
Full example: [`examples/quest_guide_gameplay_loop.json`](../../examples/quest_guide_gameplay_loop.json). More detail: [`docs/规格与生成/quest-guide-dsl.md`](quest-guide-dsl.md).

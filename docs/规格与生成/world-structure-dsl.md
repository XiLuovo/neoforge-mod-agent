...
这句话描述的是 V5.4 World / Structure DSL 这个功能层的稳定路径边界，不否定 V8.4+ 的 Direct Code Lane。当前全局边界以 [project-limitations.md](../总览/project-limitations.md)、[direct-code-lane.md](../Agent与能力/direct-code-lane.md) 和 [agent-workflow.md](../Agent与能力/agent-workflow.md) 为准。

...
| public build smoke | `public-build-smoke-clean` | mock showcase + `--build`：5 passed / 0 failed / 1 skipped（quality gate 未请求），doctor 22 pass / 0 warning，development e2e 2/2 success，audit 2/2，Gradle build 2/2，生成 `progression_mod-0.1.0.jar` 和 `ruby_mod-0.1.0.jar` | 不证明真实 provider 或 Minecraft runtime；冻结报告见 `evidence/portfolio/` |

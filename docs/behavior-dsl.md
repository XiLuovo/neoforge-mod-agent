...
这句话描述的是 V5.1 Behavior DSL 这个功能层的稳定路径边界：行为逻辑先收束为 DSL，再由 generator 落地。它不否定 V8.4+ 的 Direct Code Lane；当前全局边界以 [project-limitations.md](project-limitations.md)、[direct-code-lane.md](direct-code-lane.md) 和 [agent-workflow.md](agent-workflow.md) 为准。
